...
def postProcessing_noTWIST_202405212034(angle0=3620.0):
    df = pd.read_csv("postProcessing_noTWIST_202405212034/turbines/0/turbine.csv")
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        postProcessing_noTWIST_202405212034()
        plot_spanwise()
